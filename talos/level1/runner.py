...
from talos.level1.genome import GENOME_LENGTH, gene_bounds, gene_names
...
def run_nsga2_pymoo(
    ...
    try:
        ...
        raise ImportError(
            "pymoo is required to run Level 1 NSGA-II. Install it with `pip install pymoo`."
        ) from exc
